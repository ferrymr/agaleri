  ...
  $(function(){
    ...
    $('#id_retur').on('change', function (e) {
      ...
      if (id_retur.val() == null) {
        ...
        url = "{{ url('get_detail_retur_bb_gudang') }}";
        ...
        $.ajax({
          ...
          for (var i = 0; i < data.data.length; i++) {
            ...
            $('[name="kode_bb[]"]').eq(i).val(data.data[i]['kode_bb']);
            $('[name="nama_bb[]"]').eq(i).val(data.data[i]['nama_bb']);
            $('[name="id_bb[]"]').eq(i).val(data.data[i]['id_bb']);
            $('[name="nama_warna[]"]').eq(i).val(data.data[i]['nama_warna']);
            $('[name="id_warna[]"]').eq(i).val(data.data[i]['id_warna']);
            ...
            // $('[name="qty_keluar[]"]').eq(i).attr('kode_k',data.data[i]['kode_bb']);
            // $('[name="qty_pemakaian[]"]').eq(i).attr('kode_p',data.data[i]['kode_bb']);
            // $('[name="qty_retur[]"]').eq(i).attr('kode_r',data.data[i]['kode_bb']);
            // var id_kode = data.data[i]['kode_bb'];
            // var qty_keluar = 0;
