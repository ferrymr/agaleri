...
@section('content')
@php
$data_about = \App\Param::select('name_aplikasi','name_perusahaan','copyright_year')->limit(1)->get();
@endphp
<!-- MAIN PANEL -->
          ...
          <div class="jarviswidget jarviswidget-color-orange jarviswidget-sortable" id="wid-id-1" data-widget-editbutton="false" role="widget">
            ...
            <div role="content">
              ...
              <div class="widget-body">
                <div role="content">
                  <div class="widget-body">
                    <!-- <img src='{{ url("template/img/bg/bg4.jpg") }}' height= alt=""> -->
                    <p>{{ $data_about[0]->name_aplikasi }} merupakan aplikasi Online Shop, lisensi diberikan kepada perusahaan {{ $data_about[0]->name_perusahaan }} </p>
                  </div>
                </div>
              </div>
        </article>
