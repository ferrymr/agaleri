      ...
      if (id_so.val() == null) {
        ...
        $.ajax({
          ...
          for (var i = 0; i < data.permintaan.length; i++) {
            ...
            $('[name="qty_permintaan[]"]').eq(i).attr('kode_m',data.permintaan[i]['kode_acc']);
            $('[name="qty_keluar[]"]').eq(i).attr('kode_k',data.permintaan[i]['kode_acc']);
            $('[name="qty_pemakaian[]"]').eq(i).attr('kode_p',data.permintaan[i]['kode_acc']);
            $('[name="qty_retur[]"]').eq(i).attr('kode_r',data.permintaan[i]['kode_acc']);
