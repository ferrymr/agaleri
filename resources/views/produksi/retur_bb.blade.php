                    ...
                    <div class="widget-body">
                      <form id="formAdd" class="form-horizontal" method="post" data-toggle="validator" enctype="multipart/form-data">
                        ...
                        <fieldset>
                          ...
                          <div class="itemLine col-md-1">
                            <input name="qty_retur[]" kode="" onblur="calc_qty_retur();" type="decimal" class="form-control decimal" value="">
                          </div>
                          <div class="itemLine col-md-1">
    ...
    $('#id_so').on('change', function (e) {
      ...
      if (id_so.val() == null) {
        ...
        $.ajax({
          ...
          data : {id_so},
          success : function(data) {
          $('#no_bukti_permintaan').val(data.id_permintaan);
          ...
          for (var i = 0; i < data.permintaan.length; i++) {
            ...
            $('[name="qty_permintaan[]"]').eq(i).attr('kode_m',data.permintaan[i]['kode_bb']);
            $('[name="qty_keluar[]"]').eq(i).attr('kode_k',data.permintaan[i]['kode_bb']);
            $('[name="qty_pemakaian[]"]').eq(i).attr('kode_p',data.permintaan[i]['kode_bb']);
            $('[name="qty_retur[]"]').eq(i).attr('kode_r',data.permintaan[i]['kode_bb']);
            ...
            $('[name="satuan[]"]').eq(i).val(data.permintaan[i]['nama_satuan']);
