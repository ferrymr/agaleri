                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-10">
                      <label class="radio radio-inline">
                        <input type="radio" value="asset" class="radiobox" name="type">
                        <span>Asset</span>
                      </label>
                      <label class="radio radio-inline">
                        <input type="radio" value="liability" class="radiobox" name="type">
                        <span>Liability</span>
                      </label>
                      <label class="radio radio-inline">
                        <input type="radio" value="equity" class="radiobox" name="type">
                        <span>Equity</span>
                      </label>
                      <label class="radio radio-inline">
                        <input type="radio" value="income" class="radiobox" name="type" checked>
                        <span>Income</span>
                      </label>
                      <label class="radio radio-inline">
                        <input type="radio" value="expense" class="radiobox" name="type">
                        <span>Expense</span>
                      </label>
                    </div>
                  </div>
