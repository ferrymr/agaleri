  ...
  <table id="table_detail" class="x table table-striped table-bordered table-hover" width="100%">
    <thead>
      <tr style="height:25px;">
        ...
        <th class="x" align="center">NAMA BARANG</th>
        <th class="x" align="center">QTY</th>
        <th class="x" align="center">SATUAN</th>
        <th class="x" align="center">HARGA BELI</th>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="x" align="center">{{ $v->id_bb }}</td>
        <td class="x" align="center">{{ $v->nama_bahan_baku }}</td>
      ...
      <tr style="border-bottom: 0 !important;">
          <td colspan="7" class="x" align="right"></td>
