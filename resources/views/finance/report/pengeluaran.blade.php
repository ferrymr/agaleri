            ...
            <div class="widget-body">
              <form id="formAdd" name="formAdd" method="post" class="form-horizontal" data-toggle="validator" enctype="multipart/form-data">
                ...
                <fieldset>
                  ...
                  <div class="itemLine col-md-2">
                    <select style="width:100%" id="id_akun" name="id_akun" class="form-control"></select>
...
// Date Range Picker
  ...
  // $('[name=id_akun]').next(".select2-container").show();
  ...
  //     $('[name=id_cmt]').next(".select2-container").hide();
  //     } else {
  //     $('[name=id_akun]').next(".select2-container").hide();
  ...
  $('#view').on('click', function (e) {
    ...
    window.open(baseurl+'/laporan_pengeluaran/view/'+from+'/'+to+'/'+id);
