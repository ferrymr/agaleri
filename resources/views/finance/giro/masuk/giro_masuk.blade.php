                    ...
                    <form id="formAdd" name="formAdd" method="post" class="form-horizontal" data-toggle="validator" enctype="multipart/form-data">
                      ...
                      <fieldset>
                        <div class="form-group">
                          <label class="col-md-2 control-label">Tanggal Penerimaan</label>
                          <div class="col-sm-2">
                        ...
                        <div class="form-group">
                          <label class="col-md-2 control-label">Diterima Dari </label>
                          <div class="col-md-2">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-2">
                            <input class="form-control" type="text" name="id_akun_kredit" value="" readonly>
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="col-md-2 control-label">Nomor Giro/ Cheque </label>
                          <div class="col-md-2">
                            <input class="form-control" type="text" name="no_giro_pelanggan" value="">
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="col-md-2 control-label">Kode Perkiraan Debit </label>
                          <div class="col-md-2">
                            <input class="form-control" type="text" name="id_akun_debit" value="1101030001" readonly>
                          </div>
                          <div class="col-md-3">
                            <input class="form-control" type="text" name="nama_id_akun_debit" value="GIRO PEMBAYARAN ATAU GIRO DITANGAN" readonly>
                          </div>
                        </div>
                        <div class="form-group">
