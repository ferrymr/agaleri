...
<div id="content">
                    ...
                    <form id="formAdd" name="formAdd" method="post" class="form-horizontal" data-toggle="validator" enctype="multipart/form-data">
                      {{ csrf_field() }} {{ method_field('POST') }}
                        <div class="form-group">
                          <label class="col-md-4 pull-right control-label" style="font-size:25px;"><strong>Total Sisa Rp. {{ $sisa }}</strong></label>
                        </div>
                      <hr>
                      <fieldset>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-2">
                          <input type="hidden" id="no_invoice" name="no_invoice" class="form-control" value="{{ $no_invoice }}">
                          <input type="hidden" id="id_costumer_text" name="id_costumer_text" class="form-control" value="{{ $id_costumer }}">
                        ...
                        <fieldset>
                          ...
                          <div id="detail">
                            <div class="detailLine form-group">
                              ...
                              <div class="itemLine col-md-3">
                                <input class="form-control decimal calc" name="jumlah_bayar" style="text-align:right;" placeholder="0" type="text" value="{{ $sisa }}">
                              </div>
                            </div>
                          </div><br><br>
                          <div class="form-group">
  ...
  $(function(){
    ...
    setcostumer(costumer,'{{$id_costumer}}','{{$nama_costumer}}');
    select2Run();
    function select2Run() {
