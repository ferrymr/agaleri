    						...
    						<article class="col-sm-12 col-md-12 col-lg-12 sortable-grid ui-sortable">
    							...
    							<div class="jarviswidget jarviswidget-color-orange" id="wid-id-1"  data-widget-editbutton="false" data-widget-colorbutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-collapsed="true">
    								...
    								<div role="content">
    									...
    									<!-- widget content -->
    									<div class="widget-body">
                        <form class="form-horizontal" method="POST" action="{{ url('add_barang_jadi') }}">
                            {{ csrf_field() }}
                            ...
                            <!-- <div class="form-group">
                              ...
                              <div class="col-md-10">
                                <select style="width:100%" name="brand_id" class="select2">
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                <label for="name" class="col-md-2 control-label">Barang Jadi</label>
...
<!-- Modal -->
                ...
                <form class="form-horizontal" method="POST" action="{{ url('update_barang_jadi') }}">
                    {{ csrf_field() }}
...
function editData(id,name,status) {
  ...
  function delData(id) {
    ...
    swal({
        ...
        sendAjax('/del_barang_jadi','POST',{id:id});
        }
        });
  }
