                                ...
                                <form id="formAdd" name="formAdd" method="post" class="form-horizontal" data-toggle="validator" enctype="multipart/form-data">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2">
                                                <select style="width:100%" id="value_order" name="value_order" class="form-control">
                                                ...
                                                <select style="width:100%; display:none;" id="value_customer" name="value_customer" class="form-control">
                                                    <option value="c">Customer</option>
                                                    <option value="o">Order</option>
                                                    <option value="s">Stok</option>
                                                </select>
                                                <select style="width:100%; display:none;" id="value_stok" name="value_stok" class="form-control">
                                                    <option value="c">Customer</option>
                                                    <option value="o">Order</option>
                                                    <option value="s">Stok</option>
                                                </select>
    ...
    <script>
        ...
        $('#view_print').on('click', function(e) {
            ...
            if (from && to !== '') {
                from = from.replace(/\//g, '-');
                to = to.replace(/\//g, '-');
                window.open(baseurl + '/view_print' + from + '/' + to);
            }
        });
