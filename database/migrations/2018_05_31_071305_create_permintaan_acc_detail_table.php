...
class CreatePermintaanAccDetailTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('permintaan_acc_detail', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('permintaan_acc_detail');
    }
}
