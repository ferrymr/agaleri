...
class CreatePembayaranDetailPiutangTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pembayaran_detail_piutang', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('pembayaran_detail_piutang');
    }
}
